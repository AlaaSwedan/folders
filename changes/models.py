...
class CourseOverview(TimeStampedModel):
    ...
    # add new field  to courseware by deltasoft
    course_subject=TextField(null=True)
    ...
    def _create_or_update(cls, course):
        ...
        # add new field  to courseware by deltasof
        course_overview.course_subject = course.course_subject
        #****************************
