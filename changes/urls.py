...
urlpatterns += (
    ...
    url(
     ...
     # add new urls by deltasoft
    url(r'^subjects/','courseware.views.views.subjects',
        name='subjects',
        ),
    url(r'^medical_subject/','courseware.views.views.medical',
        name='medical',
        ),
    url(r'^info_technology_subject/','courseware.views.views.info_technology',
        name='info_technology',
        ),
    url(r'^programming_subject/','courseware.views.views.programming',
        name='programming',
        ),
    # ************
